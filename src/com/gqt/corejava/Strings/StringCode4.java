/**
 * String object equalsIgnoreCase
 */
 ...
 * @category Strings
 * @description To check the Strings objects are equal or not in equalsIgnoreCase
 */
public class StringCode4 {

	/**
	 * @param args
	 * @description This source code is used to check whether strings objects are equal and reference are equals in equalsIgnoreCase
	 */
