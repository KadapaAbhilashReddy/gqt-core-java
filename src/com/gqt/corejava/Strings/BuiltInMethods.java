...
public class BuiltInMethods {
	...
	public static void main(String[] args) {
		...
		// 1. length()
		int length = str.length(); // it will provide the total length of the string
		...
		//System.out.println("The character at 100th position is: " + c);
		...
		res3 = str.startsWith("Pachin"); // it will check if the substring present at the start of the main String
		System.out.println(res3);
		...
		index1 = str.indexOf('Z'); // it will provide the index of the specified character in the main string if no char then negative value
		System.out.println(index1);
		...
		lastindex = str.lastIndexOf('z'); // it will provide the negative value if the char is not in the string
		System.out.println(lastindex);
		...
		//17. toLowerCase()
		String lowerCase = str.toLowerCase(); // it convert string to lower case
